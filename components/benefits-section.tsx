          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="text-center">
                <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-green-100 to-orange-100">
                  {React.createElement(benefit.icon, { className: "h-8 w-8 text-green-600" })}
                </div>
